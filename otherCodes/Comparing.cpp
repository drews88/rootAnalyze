...
/*
    Adapted from Comparing109CdChargeSpectra.ipynb(Author: Collin Arbour)
    Author: Drew Swinson
*/
...
//
    ...
    // Using Fresh CF4
    TH1F *mBkg, *mSrc;
    getData("../root_files/05_centralGas_Cd_Scans/dark/raw3600/output.root", mBkg, true);
    getData("../root_files/05_centralGas_Cd_Scans/wSrc/hole2/raw3600/output.root", mSrc);
    ...
    cCanv->Draw();
    cCanv->SaveAs("./plots/mBackgroundCorrected.pdf");
    ...
    cCanv2->Draw();
    //cCanv2->SaveAs("./plots/RawSBandSComparison.pdf");
